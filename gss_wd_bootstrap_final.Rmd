...
ranging from 0 to 1. For each run of the management strategy evaluation, 1 of the 100 bootstrap runs was forward projected with 1 of 10 randomly generated bootstrapped recruitment series , yielding 1000 stochastic simulations. A series of $F_{target}$ values (0 - 1 in steps of 0.01) were then tested by projecting harvesting of each $F_{target}$ for 100 years under in each of the 1000 simulations (100 000 in total).  
...
Figure
\ref{fig:ssbfor} shows the evolution of catches, SSB and fishing mortality for select values of $F$ are shown. The equilibrium yield curve is shown in figure
